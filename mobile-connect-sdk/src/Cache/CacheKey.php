...
class CacheKey
{
    ...
    /**
     * Create an instance of CacheKey
     *
     * @param string $mcc The MCC.
     * @param string $mnc The MNC.
     * @return CacheKey A CacheKey with the operator details.
     */
    public static function newWithDetails($mcc, $mnc)
    {
        ...
        return new CacheKey($mcc, $mnc);
    }

    /**
     * Create an instance of CacheKey with the selected MCC and MNC
     * set.
     *
    ...
    {
        if ($selectedMCC == null || $selectedMNC == null) {
            return null;
        }

        return new CacheKey($selectedMCC, $selectedMNC, null, null);
    }

    /**
     * Create an instance of CacheKey with the identified MCC and MNC
     * set.
     *
     * @param string $identifiedMCC The identified MCC.
     * @param string $identifiedMNC The identified MNC.
     * @return CacheKey|null A CacheKey with the details of the identified operator.
     */
    public static function newWithIdentifiedData($identifiedMCC, $identifiedMNC)
    {
        if ($identifiedMCC == null || $identifiedMNC == null) {
            return null;
        }
